...
// Importa os componentes primitivos de Dialog da Radix UI
import * as DialogPrimitive from "@radix-ui/react-dialog"
// Importa o ícone X do Lucide para o botão de fechar
import { X } from "lucide-react"

// Importa função utilitária para juntar classes CSS dinamicamente
import { cn } from "../../lib/utils"

// Componente raiz do Dialog (controla o estado do diálogo)
...
// Componente do conteúdo principal do diálogo (caixa de diálogo)
...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        // Estilização do conteúdo: centralizado, animado, responsivo e com sombra
...
// Componente para o cabeçalho do diálogo (usado para título e descrição)
const DialogHeader = ({
  className,
  ...props
...
// Componente para o rodapé do diálogo (usado para ações ou informações extras)
const DialogFooter = ({
  className,
  ...props
}: React.HTMLAttributes<HTMLDivElement>) => (
